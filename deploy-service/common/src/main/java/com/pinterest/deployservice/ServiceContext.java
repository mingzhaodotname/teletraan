...
public class ServiceContext {
    ...
    public Pg2PackagesDAO getPg2PackagesDAO() {
        return pg2PackagesDAO;
    }

    public void setPg2PackagesDAO(Pg2PackagesDAO pg2PackagesDAO) {
        this.pg2PackagesDAO = pg2PackagesDAO;
    }
